      ...
      <div className="bg-white dark:bg-slate-900 w-full max-w-4xl max-h-[90vh] rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-base font-bold text-slate-900 dark:text-white flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase font-black px-2 py-0.5 rounded-full bg-indigo-100 text-indigo-800 dark:bg-indigo-950 dark:text-indigo-300 border border-indigo-200">
                  ZemdaTO
                </span>
              </h2>
        ...
        <div className="px-6 py-3 border-b border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/20 flex items-center justify-between text-xs font-bold">
          <div className="flex items-center gap-2">
            <span
              className={`w-6 h-6 rounded-full flex items-center justify-center text-xs ${
                step === 'generate' ? 'bg-indigo-600 text-white' : 'bg-emerald-500 text-white'
              }`}
            >
              1
            </span>
            <span className={step === 'generate' ? 'text-indigo-600' : 'text-slate-500'}>Gerar Síntese</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className={step === 'review' ? 'text-indigo-600' : 'text-slate-500'}>Revisão Profissional</span>
          </div>
            ...
            <div className="space-y-5 max-w-2xl mx-auto">
              ...
              <div className="pt-2 flex justify-end">
                <button
                  ...
                  className="inline-flex items-center gap-2 px-6 py-2.5 text-xs font-bold text-white bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 rounded-xl shadow-md shadow-indigo-500/20 transition-all cursor-pointer disabled:opacity-50"
                >
          ...
          {step === 'review' && (
            <div className="space-y-4">
              ...
              <textarea
                ...
                className="w-full p-4 text-xs font-mono rounded-2xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900/50 leading-relaxed focus:outline-none focus:border-indigo-500"
              />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                {onInsertIntoConsultation && (
                  <button
                    ...
                    className="p-4 rounded-2xl border border-indigo-200 bg-indigo-50/50 hover:bg-indigo-100 text-indigo-900 flex flex-col items-center gap-2 transition-all cursor-pointer"
                  >
                    <FileText className="w-5 h-5 text-indigo-600" />
                    <span className="text-xs font-bold">Inserir na Consulta</span>
                    <span className="text-[10px] text-slate-500">Adicionar à evolução atual</span>
                  </button>
                )}
