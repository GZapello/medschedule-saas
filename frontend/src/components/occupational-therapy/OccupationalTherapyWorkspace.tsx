...
export const OccupationalTherapyWorkspace: React.FC<OccupationalTherapyWorkspaceProps> = ({
  ...
  const toQuickTools: ClinicalQuickToolItem[] = [
    ...
    {
      id: 'routine_map',
      label: 'Mapa da Rotina',
      icon: LayoutDashboard,
      onClick: () => setIsRoutineMapOpen(true)
    },
    {
      id: 'moho_participation',
      label: 'Participação (MOHO)',
      icon: User,
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-xs space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Ex: Órtese de punho termoplástica, engrossador de talher, adaptação de tesoura..."
