      ...
      {open && (
        <>
          ...
          <div
            ...
            className="absolute left-0 right-0 top-full mt-2 z-50 bg-white rounded-2xl border border-slate-200 shadow-2xl overflow-hidden flex flex-col max-h-[460px] sm:max-h-[520px] w-full animate-in fade-in-50 zoom-in-95 duration-150 ring-1 ring-black/5"
          >
            {/* Search Input Box */}
            <div className="p-3 bg-slate-50 border-b border-slate-100 shrink-0 space-y-1.5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-9 py-2.5 text-sm bg-white border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-slate-800 placeholder:text-slate-400 transition-all shadow-xs"
            ...
            <div className="overflow-y-auto overscroll-contain flex-1 divide-y divide-slate-100 max-h-[380px] sm:max-h-[440px] scroll-smooth">
              {loading ? (
                ...
                filteredList.map((option, idx) => {
                  ...
                  return (
                    <div
                      ...
                      className={`px-4.5 py-3.5 text-sm cursor-pointer transition-all flex items-center justify-between gap-3 border-l-4 ${
                        isSelected
                    ...
                    >
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {option.boardLabel && (
                            <span className="text-[10px] font-black px-2 py-0.5 rounded-md bg-slate-100 text-slate-700 border border-slate-200 uppercase tracking-wide">
                              {option.boardLabel}
                            </span>
                          )}
                        </div>
                        <div className="text-xs text-teal-700 font-medium mt-1 flex items-center gap-1.5">
